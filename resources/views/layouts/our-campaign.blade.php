...
<html lang="en">
  <head>
    ...
    <title>Our Campaign - Tasanesia</title>
  </head>
  <body>
    <!-- Navbar -->
    @include('partials.navbar')
    <!-- End Navbar -->
    <!-- <hr style="color: #27ae60; margin-top: 85px; width: 100%" ; /> -->

    <section class="id">
      <div class="container">
        <div class="col-lg-6 me-auto ms-auto" style="margin-top: 95px">
          <h2 class="">HALAL FOOD GOES TO AMERICA MARKET</h2>
          <div class="d-flex mb-3 p-2 align-items-center">
            <img
              ...
              class="img-penulis"
            />
            <p class="nama-penulis">Dibuat oleh admin, 20 Januari 2021</p>
          </div>
          <div class="container">
            <img
    ...
    <!-- <hr style="color: #27ae60; margin-top: 90px; width: 100%" ; /> -->
<!-- Navbar -->
